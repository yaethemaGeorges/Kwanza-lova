...
const kUserKey =
  "os_v2_app_cxxklujo6jaiff7ubewmz4k6oet6xh6cisrevwuabe4eiktahkbamf7ziabgembt3p3hvi6rjpuaol6uhl5c4ojpdwb7prvurlq5dey";
const kAPIKey =
  "os_v2_app_cxxklujo6jaiff7ubewmz4k6oet6xh6cisrevwuabe4eiktahkbamf7ziabgembt3p3hvi6rjpuaol6uhl5c4ojpdwb7prvurlq5dey";
  ...
  .https.onCall(async (data, context) => {
    ...
    try {
      ...
      const createdUser = await client.createUser(
        "15eea5d1-2ef2-4082-97f4-092cccf15e71",
        user,
      );
...
exports.deleteUser = functions
  ...
  .https.onCall(async (data, context) => {
    ...
    const url = `https://api.onesignal.com/apps/15eea5d1-2ef2-4082-97f4-092cccf15e71/users/by/external_id/${data.user_id}`;
